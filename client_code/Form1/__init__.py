...
class Form1(Form1Template):
  ...
  def mentes_click(self, **event_args):
    ...
    "": {
        ...
        "pszi": [self.pszi.text, self.termeszetes_asztral, self.statikus_asztral, self.dinamikus_asztral, self.me_asztral, self.termeszetes_mental, self.statikus_mental, self.dinamikus_mental, self.me_mental, self.pszi_af.checked, self.pszi_mf.checked, self.pszi_pyarroni.checked, self.pszi_slan.checked, self.pszi_kyr.checked, self.pszi_siopa.checked],
        ...
        "levonasok": [["","","",""],["","","",""]],
        "penz": [[self.arany_1.text, self.ezust_1.text, self.rez_1.text, self.hol_1.text],[self.arany_2.text, self.ezust_2.text, self.rez_2.text, self.hol_2],[self.arany_3.text, self.ezust_3.text, self.rez_3.text, self.hol_3.text]],
